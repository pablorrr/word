...
function create_sidebar()
{
    register_sidebar(array(
        'name' => 'widget',
		'id' => 'moj-widget',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',//kod html przed widgetem
        'after_widget' => '</div>',//kod za widgetem
        'before_title' => '<h2 class="widgettitle">',//kod html przed nazwa widgetu
        'after_title' => '</h2>',//kod po nazwie 
    ));
}
