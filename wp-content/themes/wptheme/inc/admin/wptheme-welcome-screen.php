...
class wptheme_Welcome_Screen {
	...
	public function __construct() {
		...
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_intro' ), 			10 );
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_tabs' ), 				20 );
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_getting_started' ), 	30 );
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_pro' ), 				40 );
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_doc' ), 				60 );
		add_action( 'wptheme_welcome', array( $this, 'wptheme_welcome_about' ), 			70 );
