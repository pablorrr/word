...
// ---------------------------------------------
	...
	if (!is_admin()){
		//load Bootstrap Css
		wp_enqueue_style( 'wptheme-bootstrap-css', get_template_directory_uri() . '/inc/assets/css/bootstrap.min.css' );	
		// load theme styles
		wp_enqueue_style( 'wptheme-css', get_template_directory_uri() . '/inc/assets/css/lares-css/culinares.css', array(),'1.0', false );
		...
		//timeline effect
		wp_enqueue_style( 'wptheme-timeline-css', get_template_directory_uri() . '/inc/assets/css/lares-css/timeline.css', array(), '1.0.0', 'all' );	
...
// --------------------------------------------------		
	...
	wp_enqueue_script('wptheme-form-val-book', get_template_directory_uri() . '/inc/assets/js/validate-booking-form.js', false, '1.0.0', true ); 
	//affix plugin
