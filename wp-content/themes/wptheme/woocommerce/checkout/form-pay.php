	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'larestaurante' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'larestaurante' ); ?></th>
			</tr>
		</thead>
		<tbody>
